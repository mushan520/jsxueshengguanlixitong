...
function bindEvent() {
    ...
    menu.onclick = function (e) {
        ...
        if (target.tagName == 'DD') {
            ...
            // var id = target.dataset.id;     //也可以通过data-  这个特殊属性来获取id的值
    ...
    studentAddBtn.onclick = function (e) {
        ...
        if (data) {
            // var str = 'appkey=_mushan_1596698489710';
...
function getTableData() {
    // ajax('GET', 'http://open.duyiedu.com/api/student/findAll', 'appkey=_mushan_1596698489710', function (res) {
    //     console.log(res)
    //     if (res.status == 'success') {
